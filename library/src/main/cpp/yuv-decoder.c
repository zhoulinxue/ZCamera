...
Java_org_zhx_common_camera_YUVTorgb_YUVtoRBGA(JNIEnv *env, jobject obj,
                                                                        jbyteArray yuv420sp,
...
JNIEXPORT void JNICALL
Java_org_zhx_common_camera_YUVTorgb_YUVtoARBG(JNIEnv *env, jobject obj,
                                                                       jbyteArray yuv420sp,
                                                                       jint width, jint height,
                                                                       jintArray rgbOut) {
    int sz;
...
JNIEXPORT void JNICALL
Java_org_zhx_common_camera_YUVTorgb_adjustBitmap(JNIEnv *jenv, jclass thiz,
                                                                       jobject src) {
