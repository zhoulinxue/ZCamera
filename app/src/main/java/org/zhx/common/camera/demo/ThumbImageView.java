...
public class ThumbImageView extends AppCompatImageView{
    ...
    private void init() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setOutlineProvider(new ThumbImageView.OutlineProvider());
        }
    ...
    private void initializeBitmap() {
        ZCameraLog.e("initializeBitmap, mDisableCircularTransformation： " + mDisableCircularTransformation + hashCode());
        if (mDisableCircularTransformation) {
            mBitmap = null;
        } else {
